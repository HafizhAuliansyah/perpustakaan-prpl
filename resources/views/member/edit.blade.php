...
@section('content')
    ...
    <form action="{{route('member.update', $data->NIK)}}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control @error('NIK') is-invalid @enderror" id="exampleInputNIK" placeholder="NIK" name="NIK" value="{{$data->NIK||old('NIK')}}">
                            @error('NIK') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label for="exampleInputNama">Nama</label>
                            <input type="text" class="form-control @error('Nama') is-invalid @enderror" id="exampleInputNama" placeholder="Nama lengkap" name="Nama" value="{{$data->Nama??old('Nama')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('NomorTelepon') is-invalid @enderror" id="exampleInputNomorTelepon" placeholder="Masukkan Nomor Telepon" name="NomorTelepon" value="{{$data->NomorTelepon??old('NomorTelepon')}}">
